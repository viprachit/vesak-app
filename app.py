...
def render_invoice_ui(df_main, df_history_data, mode="standard"):
    ...
    with col1:
        ...
        next_sequential_inv = get_next_invoice_number_gsheet(inv_date, df_history_data, c_location)
                            ...
                            if show_dup_nurse or show_dup_pat:
                                ...
                                <body>
                                    ...
                                    <div class="page">
                                        ...
                                        <div class="title">{d_doc_type}</div>
                                        <br>
                                        <div class="content">
                                            <p><strong>Date:</strong> {fmt_date_rep}</p>
                                            <p><strong>Ref No:</strong> {c_ref_no_rep}</p>
                                            <p><strong>Client Name:</strong> {c_name_rep}</p>
                                            <br>
                                            <p>This is a duplicate copy of the agreement.</p>
                                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                                            <br><br><br>
                                            <p>__________________________<br>Authorized Signatory</p>
                                        </div>
