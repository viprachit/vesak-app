...
<head>
    ...
    <style>
        ...
        .watermark-container {{
    		...
    		left: 50%; /* half of A4 width */
    		transform: translateX(-50%) translateY(-50%); pointer-events: none; z-index: 0;
		}}
        .watermark-text {{
...
<body class="py-10">
    ...
    <div class="invoice-page" id="invoice-content">
        <div class="watermark-container">
            <img src="data:image/png;base64,{logo_b64}" style="display:block; margin:0; padding:0; width:300px; opacity:0.015;">
